...
from market_data.serving.indicators import INDICATOR_CALCULATION_VERSION, IndicatorSpec
...
from market_data.serving.volume_profile import VOLUME_PROFILE_EXACT_CALCULATION_VERSION
