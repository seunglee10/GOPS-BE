...
from market_data.alpaca.feed_profiles import market_session_for_timestamp, visible_extended_session_windows
from market_data.backfill.gapfill import TradingCalendar
from market_data.common.symbols import is_crypto_symbol
from market_data.serving.closed_watermark import live_candle_after_latest_closed
from market_data.serving.clickhouse_provider import ClickHouseMarketDataProvider, with_higher_timeframe_closed_state
from market_data.serving.cursors import timestamp_from_cursor
from market_data.serving.dto import cursor_for, snapshot
...
from market_data.serving.session_buckets import aggregate_visible_extended_session_candles
...
def merge_candles(*groups, now=None):
    ...
    if rows and len(intervals) == 1 and intervals.issubset({"1D", "1W", "1M"}):
        from market_data.analytics.analysis_candles import merge_canonical_candles
