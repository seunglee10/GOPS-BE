...
MATCHER_ID = "paper-replay-matcher-v1"
...
def _match_quote(
    ...
    repository.match_quote(
        ...
        bid_size=_positive_decimal(quote.get("bidSize") or quote.get("bid_size")),
        ask_size=_positive_decimal(quote.get("askSize") or quote.get("ask_size")),
